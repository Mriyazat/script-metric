#!/usr/bin/env python3
"""One round of the identification game, end to end, plus its repeated accuracy."""
import numpy as np
import pandas as pd
...
from pipeline.common.paths import EVENTS, FIG, MODELS
...
def build_profile(df):
    ...
    nb = 10
    df = df.sort_values(["response_id", "position"], kind="stable")
    ...
    # slot convention (scriptmetric.metric.compute default)
