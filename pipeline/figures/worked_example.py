#!/usr/bin/env python3
"""From one annotated reply to the number: highlights, events, pooled tables, calibration.
Reads out/derived/figdata/ (metric/figure_data.py)."""
import json

import numpy as np
from pipeline.common import style as S

S.setup()
import matplotlib.pyplot as plt
import matplotlib.gridspec as gridspec

from pipeline.common.paths import FIG, REF
...
axA.axis("off")
pass  # panel letters are given in the caption
...
S.flow(fig, between(axB, axP) - 0.006,
       f"pool the events of all {int(P['score']['n_responses'])} Claude replies", x=0.30)
