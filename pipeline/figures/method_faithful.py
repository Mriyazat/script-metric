#!/usr/bin/env python3
"""The instrument at full resolution: 20 codes, 10 bins, the two count tables and the score.
Reads out/derived/figdata/."""
import json
...
S.flow(fig, between(axB, axP) - 0.004,
       f"pool the events of all {int(F['score']['n_responses'])} Claude replies", x=0.32)
