#!/usr/bin/env python3
"""Explanatory figures: the null spike, the C/M decomposition, and the therapist comparison."""
import numpy as np
import pandas as pd
import matplotlib
...
from pipeline.common.paths import EVENTS, FIG, MODELS, REF, TAB
...
axes[0].set_xlabel("observed", fontsize=10)
axes[1].set_xlabel("one draw of the within-reply shuffle null", fontsize=10)
...
fig.savefig(FIG / "fig_anatomy_simple.png", dpi=300, bbox_inches="tight")
fig.savefig(FIG / "fig_anatomy_simple.pdf", bbox_inches="tight")
plt.close(fig)
...
# speakers on identical prompts; built by metric/therapist_baseline.py)
...
ax1.axhline(0, color="#888888", ls=":", lw=0.9, zorder=0)
