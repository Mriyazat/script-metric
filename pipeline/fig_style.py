"""Shared visual language for the explanatory figures (14, 16-19).

Colours come from the ltc palettes used throughout the paper:
  behaviour groups .. ltc "minou"   (#00798c / #d1495b / #edae49 / #66a182 ...)
  model identities .. ltc "shuggie"/"trio4" accents (as in 03_profile_suite)
  heatmaps .......... ltc "heatmap0" ramp, light -> dark
"""
import matplotlib
...
def tag(ax, letter, x=-0.01, y=1.02):
    """Panel letter, paper style: bold (a) at the top-left of the axes."""
